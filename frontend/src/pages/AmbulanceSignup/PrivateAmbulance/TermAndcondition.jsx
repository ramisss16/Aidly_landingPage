...
const PrivateAmbulance_TermsCondition = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-[#1A5F48] via-[#89C9CA] to-[#C6EBE8] p-4">
      ...
      <div className="w-full max-w-lg bg-white rounded-2xl shadow-xl p-5 sm:p-8 -mt-15">
        ...
        <button onClick={()=>navigate("/Private-Ambulance-ThankuPage")} className="mt-6 w-full bg-blue-600 hover:bg-blue-700 transition text-white py-2.5 rounded-lg font-medium shadow-md">
          Accept and Continue
        </button>
...
export default PrivateAmbulance_TermsCondition;