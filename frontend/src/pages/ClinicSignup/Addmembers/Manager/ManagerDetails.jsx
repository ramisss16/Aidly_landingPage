...
const Clinic_Manager_Details = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await api.post("/clinic/manager/register", form, {
        headers: {
      ...
      sessionStorage.setItem("managerId", response.data.data.managerId);
                ...
                {passwordValue && (
                  <div className="mt-2 text-sm text-gray-700">
                    {passwordValidation.isValid ? (
                      <p className="text-green-600">✅ Password looks good.</p>
                    ) : (
...
export default Clinic_Manager_Details;
