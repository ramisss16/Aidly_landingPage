...
const ClinicAdminDetails = () => {
  ...
  const [formData, setFormData] = useState(() => {
    const savedData = sessionStorage.getItem("clinicAdminForm");
  ...
  const handleChange = (e) => {
    ...
    sessionStorage.setItem("clinicAdminForm", JSON.stringify(updatedData));
  };
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // clear saved form
      sessionStorage.removeItem("clinicAdminForm");
